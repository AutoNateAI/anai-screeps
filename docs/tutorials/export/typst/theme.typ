...
#let panel = rgb("#eef7f3")
#let code-bg = rgb("#111827")
#let code-fg = rgb("#e5eef8")

#let tutorial-doc(title: "Screeps Tutorial", source: none, body) = {
  ...
  set page(
    ...
    footer: context {
      ...
      grid(
        columns: (1fr, auto),
        align: (left, right),
        text(size: 7.5pt, fill: muted)[Local Screeps curriculum],
  ...
  show heading.where(level: 1): it => {
    block(
      ...
      #grid(
        columns: (1fr, auto),
        align: (left, right),
        text(size: 8.5pt, fill: rgb("#bfd7ea"))[A practical local-server Screeps module],
